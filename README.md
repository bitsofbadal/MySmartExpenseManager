...
*   Smart Summary:
    ...
    *   Displays Savings if you are within budget.
    *   Alerts you with a Debt (Karjaa) message if you overspend.

##  Technical Implementation
This project was built to showcase Modular Programming in Java. 
*   Methods:Separate methods for adding expenses, viewing history, and calculating summaries to ensure code reusability.
*   GUI: Uses `javax.swing.JOptionPane` for an interactive user experience rather than a basic console-only interface.
*   Data Handling: Uses static variables and basic arithmetic logic to track financial status.
